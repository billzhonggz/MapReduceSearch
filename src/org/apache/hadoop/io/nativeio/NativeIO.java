        ...
        static {
            if (NativeCodeLoader.isNativeCodeLoaded()) {
                try {
                    ...
                    // after warning
                    PerformanceAdvisory.LOG.debug("Unable to initialize org.apache.hadoop.io.nativeio.NativeIO libraries", t);
                }
            }
        }
            ...
            if (!Shell.WINDOWS) {
                ...
                try {
                    ...
                    if (nioe.getErrorCode() == 3) {
                        ...
                        LOG.warn(String.format("org.apache.hadoop.io.nativeio.NativeIO.chmod error (%d): %s",
            ...
            if (!Shell.WINDOWS) {
                ...
                try {
                    ...
                    if (nioe.getErrorCode() == 6) {
                        ...
                        LOG.warn(String.format("org.apache.hadoop.io.nativeio.NativeIO.getFstat error (%d): %s",
                                nioe.getErrorCode(), nioe.getMessage()));
                        throw new NativeIOException("Unknown error", Errno.UNKNOWN);
                    }
                }
